  ...
  return (
    <>
      ...
      <div className="container flex lg:flex-nowrap items-center">
        ...
        {/* Thông tin sách */}
        <div className="w-3/5 bg-gray-300 p-6 rounded-lg mr-20 mt-10">
          <h2 className="text-5xl font-bold text-[#2D3250]">{book.title}</h2>
          <p className="text-xl text-gray-700 mt-5">Book ID: {book.Book_ID}</p>
          ...
          <p className="text-xl text-gray-700 mt-5">Publish Date: {book.Publish_date}</p>
          <p className="text-xl text-gray-700 mt-5">Price: {book.price.toLocaleString()} VND</p>
          <p className="text-xl text-gray-700 mt-5">Conditions: {book.conditions}</p>
